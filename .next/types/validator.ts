...
// Validate ../../src/app/api/jiya/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/jiya">> = Specific
  const handler = {} as typeof import("../../src/app/api/jiya/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
