            ...
            <div className="side-nav-container w-container">
              ...
              >
                {shrinkSidebar ? (
                  ...
                  <>
                    <a href="/" className="side-nav-link w-nav-link w--current">
                      Home
                    </a>
                    <a href="/projects" className="side-nav-link w-nav-link">
                      My works
                    </a>
                    <a href="#about" className="side-nav-link w-nav-link">
                      About
                    </a>
                    <a href="#contact" className="side-nav-link w-nav-link">
                      Contact
                    </a>
                  </>
                )}
